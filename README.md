...
A read-only table column that displays a numeric value (0–100) as a coloured horizontal progress bar with the percentage label centred on it. Values outside the 0–100 range are clamped automatically.
